        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <AnimatedSection className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-7 shadow-[0_24px_64px_rgba(0,0,0,0.5)] backdrop-blur-2xl backdrop-saturate-150">
            ...
            <div className="relative mt-6 grid gap-3 sm:grid-cols-2">
              <button type="button" onClick={() => navigate('/start-new-project/services?tab=services')} className="rounded-2xl border border-emerald-400/40 bg-emerald-500/20 p-4 text-left text-white transition hover:border-emerald-300/70 hover:bg-emerald-500/30">
