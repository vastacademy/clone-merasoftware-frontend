...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="hidden md:block bg-slate-950 text-slate-300 py-10">
      ...
      <div className="md:hidden mt-24">
        {/* Bottom Navigation */}
        <footer className="bg-slate-950 border-t border-white/10 fixed bottom-0 left-0 right-0 z-10">
          <div className="flex justify-between items-center px-2">
            <Link to={"/"}
              className={`flex flex-col items-center py-2 px-4 ${activeTab === 'home' ? 'text-emerald-400' : 'text-slate-400'}`}
            ...
            <Link to={user?._id ? "/wallet" : "/login"}
              className={`flex flex-col items-center py-2 px-4 ${activeTab === 'wallet' ? 'text-emerald-400' : 'text-slate-400'}`}
            ...
            >
              <div className="w-12 h-12 bg-emerald-500 rounded-full flex items-center justify-center -mt-5 shadow-lg">
                <PlusCircle size={24} className="text-white" />
              </div>
              <span className="text-xs mt-1 text-emerald-400">Explore</span>
            </Link>
            
            {/* My Project - Using onClick handler to navigate to active project */}
            <Link to={"/support"}
            className={`flex flex-col items-center py-2 px-4 ${activeTab === 'orders' ? 'text-emerald-400' : 'text-slate-400'}`}
          ...
          >
            ...
            className={`flex flex-col items-center py-2 px-4 ${activeTab === 'profile' ? 'text-emerald-400' : 'text-slate-400'}`}
