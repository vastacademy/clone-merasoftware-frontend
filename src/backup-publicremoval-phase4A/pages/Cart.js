  ...
  return (
    ...
    <div className='mx-auto max-w-7xl'>
        ...
        {paymentLoading && (
                <div className="fixed inset-0 bg-black bg-opacity-10 flex items-center justify-center z-50">
                    <div className="rounded-lg p-8  flex flex-col items-center">
                        <TriangleMazeLoader />
                        <p className="text-center mt-4 text-base text-black">Processing Payment...</p>
                    </div>
                </div>
            )}
        ...
        <div className='text-center my-3'>
            ...
            <p className="text-base text-black mb-4">Your Cart is Empty!</p>
            <Link to="/" className="text-base text-blue-500 hover:text-blue-600">
              Continue Shopping
            </Link>
          </div>
                )}
                            ...
                            return (
                                <div key={product?._id+"Add To Cart Loading"} className='w-full h-auto min-h-32 bg-white my-2 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                                    ...
                                    <div className='px-4 py-2 relative'>
                                        ...
                                        <h2 className='text-lg font-semibold text-black text-ellipis line-clamp-1'>{product?.productId?.serviceName}</h2>
                                        <p className='capitalize text-base text-black'>{product?.productId?.category?.replace(/_/g, ' ')}</p>
                                                ...
                                                {hasCoupon ? (
                                                    <div>
                                                        <p className='text-red-600 font-medium text-lg flex items-center'>
                                                            ...
                                                            <span className='text-sm ml-2 line-through text-black'>
                    ...
                    <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                        {loading ? (
                            ...
                            <div className='rounded-2xl border border-slate-200 bg-white overflow-hidden'>
                                <h2 className='text-lg font-semibold text-white bg-slate-950 px-4 py-3'>Summary</h2>
                                <div className='flex items-center justify-between px-4 gap-2 font-medium text-base text-black pt-3'>
                                    <p>Quantity</p>
                                    <p>{totalQty}</p>
                                </div>

                                <div className='flex items-center justify-between px-4 gap-2 font-medium text-base text-black'>
                                    <p>Total Price</p>
                                ...
                                {totalDiscount > 0 && (
                                    <div className='flex items-center justify-between px-4 gap-2 font-medium text-base text-green-600'>
                                        <p>Discount</p>
                                ...
                                {/* Final amount to pay */}
                                {totalDiscount > 0 && (
                                    <div className='flex items-center justify-between px-4 gap-2 font-medium text-base text-blue-600 mt-2 pt-2 border-t border-gray-200'>
                                        <p>Amount to Pay</p>
                                ...
                                <button
                                    className={`bg-blue-600 p-2 text-white text-base font-semibold w-full mt-2 ${paymentLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
