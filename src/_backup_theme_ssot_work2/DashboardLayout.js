...
const DashboardLayout = ({ children, user, walletBalance, cartCount, isLoading, activeProject }) => {
  ...
  const sidebarContent = (
    <div className="flex h-full w-full flex-col">
      <div className="border-b border-[rgb(var(--line-rgb)/0.1)] px-5 pt-8 pb-5">
      ...
      <div className="flex-1 px-3 py-4">
            ...
            <Link
              ...
              className={[
                ...
                active
                  ...
                  : 'bg-[rgb(var(--tint-rgb)/0.08)] text-[var(--text-primary)] hover:bg-[rgb(var(--tint-rgb)/0.14)]',
              ].join(' ')}
            >
        ...
        <div className="mt-6 border-t border-[rgb(var(--line-rgb)/0.1)] pt-4">
          <p className="px-3 text-sm font-semibold uppercase text-[var(--text-muted)]">
            More
          </p>
          <div className="mt-3 space-y-2">
            {secondaryLinks.map(({ to, label, icon: Icon, active }) => (
              <Link
                ...
                className={[
                  ...
                  active
                    ? 'bg-[rgb(var(--tint-rgb)/0.16)] text-[var(--text-primary)]'
                    : 'bg-[rgb(var(--tint-rgb)/0.05)] text-[var(--text-secondary)] hover:bg-[rgb(var(--tint-rgb)/0.12)]',
                ].join(' ')}
              >
      ...
      <div className="border-t border-[rgb(var(--line-rgb)/0.1)] p-4">
        <button
